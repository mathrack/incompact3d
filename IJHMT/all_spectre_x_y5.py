...
xscale('linear')
yscale('log')
axis([0.002,0.5,0.00001,0.4])
xlabel(r"${k_x}^+$")
ylabel(r"Compensated streamwise spectra ($T'$)")

savefig("all_spectre_x_y5.png",bbox_inches='tight')
savefig("all_spectre_x_y5.pdf",bbox_inches='tight')
