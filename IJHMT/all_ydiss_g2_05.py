...
plot(y_ref,ydiss_ref/tt_ref,'s',color='k',markerfacecolor='none',markeredgecolor='k')
...
#plot(y_cht,ydiss_cht/tt_cht,'+',color='k',label=r'$G=\frac{1}{2}$')
#plot(y_cht,ydiss_cht/tt_cht,'+',color='r')#,label=r'$G=\frac{1}{2}$')
plot(y_cht,ydiss_cht/tt_cht,'--+',color='r')
...
tt_cht=purge(sh3.col_values(1)[3:101])
ydiss_cht=purge(sh3.col_values(6)[3:101])
#plot(y_cht,ydiss_cht/tt_cht,':+',color='b')
...
tt_cht=purge(sh3.col_values(1)[3:101])
ydiss_cht=purge(sh3.col_values(6)[3:101])
#plot(y_cht,ydiss_cht/tt_cht,'x',color='k',label=r'$G=1$')
#plot(y_cht,ydiss_cht/tt_cht,'x',color='r')#,label=r'$G=1$')
plot(y_cht,ydiss_cht/tt_cht,'--x',color='r')
...
tt_cht=purge(sh3.col_values(1)[3:101])
ydiss_cht=purge(sh3.col_values(6)[3:101])
#plot(y_cht,ydiss_cht/tt_cht,'-x',color='g')
...
tt_cht=purge(sh3.col_values(1)[3:101])
ydiss_cht=purge(sh3.col_values(6)[3:101])
#plot(y_cht,ydiss_cht/tt_cht,':x',color='b')
...
tt_cht=purge(sh3.col_values(1)[3:101])
ydiss_cht=purge(sh3.col_values(6)[3:101])
#plot(y_cht,ydiss_cht/tt_cht,'-',color='g',label=r'$G_2=1$')
#plot(y_cht,ydiss_cht/tt_cht,'-o',color='g',markerfacecolor='none',markeredgecolor='g')
...
tt_cht=purge(sh3.col_values(1)[3:101])
ydiss_cht=purge(sh3.col_values(6)[3:101])
#plot(y_cht,ydiss_cht/tt_cht,':',color='b',label=r'$G_2=2$')
#plot(y_cht,ydiss_cht/tt_cht,':o',color='b',markerfacecolor='none',markeredgecolor='b')
...
plot(y_refd,ydiss_refd/tt_refd,'D',color='k',markerfacecolor='none',markeredgecolor='k')
...
savefig("all_ydiss_g2_05.png",bbox_inches='tight')
savefig("all_ydiss_g2_05.pdf",bbox_inches='tight')
