...
savefig("all_diss_K12.png",bbox_inches='tight')
savefig("all_diss_K12.pdf",bbox_inches='tight')

axis([-1,1,0.,0.12])
savefig("all_diss_K12_zoom.png",bbox_inches='tight')
savefig("all_diss_K12_zoom.pdf",bbox_inches='tight')
