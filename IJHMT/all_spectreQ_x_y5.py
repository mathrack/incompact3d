...
xscale('linear')
yscale('log')
axis([0.002,0.5,0.0001,0.4])
xlabel(r"${k_x}^+$")
ylabel(r"Compensated streamwise spectra ($\partial_y T'$)")

savefig("all_spectreQ_x_y5.png",bbox_inches='tight')
savefig("all_spectreQ_x_y5.pdf",bbox_inches='tight')
