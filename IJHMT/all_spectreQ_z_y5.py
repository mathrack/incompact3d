...
xscale('linear')
yscale('log')
axis([0.002,1.4,0.0005,2])
xlabel(r"${k_z}^+$")
ylabel(r"Compensated spanwise spectra ($\partial_y T'$)")

savefig("all_spectreQ_z_y5.png",bbox_inches='tight')
savefig("all_spectreQ_z_y5.pdf",bbox_inches='tight')
