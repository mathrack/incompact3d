...
plot(y_ref,ut_ref,'s',color='k',label=r'$isoQ$',markerfacecolor='none',markeredgecolor='k')
...
plot(y_cht,ut_cht,'+',color='k',label=r'$G_1=\frac{1}{2}$')
plot(y_cht,ut_cht,'+',color='r')#,label=r'$G_1=\frac{1}{2}$')
plot(y_cht,ut_cht,'--+',color='r')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht,'x',color='k',label=r'$G_1=1$')
plot(y_cht,ut_cht,'x',color='r')#,label=r'$G_1=1$')
plot(y_cht,ut_cht,'--x',color='r')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht,'o',color='k',markerfacecolor='none',markeredgecolor='k',label=r'$G_1=2$')
plot(y_cht,ut_cht,'o',color='g',markerfacecolor='none',markeredgecolor='r')#,label=r'$G_1=2$')
plot(y_cht,ut_cht,'--',color='r',label=r'$G_2=\frac{1}{2}$')
plot(y_cht,ut_cht,'--o',color='r',markerfacecolor='none',markeredgecolor='r')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht,'-',color='g',label=r'$G_2=1$')
plot(y_cht,ut_cht,'-o',color='g',markerfacecolor='none',markeredgecolor='g')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht,':',color='b',label=r'$G_2=2$')
plot(y_cht,ut_cht,':o',color='b',markerfacecolor='none',markeredgecolor='b')
...
plot(y_refd,ut_refd,'D',color='k',label=r'$isoT$',markerfacecolor='none',markeredgecolor='k')
...
savefig("all_ut.png",bbox_inches='tight')
savefig("all_ut.pdf",bbox_inches='tight')
