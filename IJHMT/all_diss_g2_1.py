...
savefig("all_diss_g2_1.png",bbox_inches='tight')
savefig("all_diss_g2_1.pdf",bbox_inches='tight')

axis([-1,1,0.,0.12])
savefig("all_diss_g2_1_zoom.png",bbox_inches='tight')
savefig("all_diss_g2_1_zoom.pdf",bbox_inches='tight')
