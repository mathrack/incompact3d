...
uu_ref=purge(sh2.col_values(10)[6:101])
vv_ref=purge(sh2.col_values(11)[6:101])
ut_ref=purge(sh2.col_values(14)[6:101])
vt_ref=purge(sh2.col_values(15)[6:101])
tt_ref=purge(sh2.col_values(16)[6:101])
...
plot(y_ref,ut_ref/sqrt(uu_ref*tt_ref),'s',color='k',label=r'$isoQ$',markerfacecolor='none',markeredgecolor='k')
...
xscale('linear')
yscale('linear')
axis([0.4,10,0.74,0.97])
xlabel(r"$y^+$")
ylabel("$\overline{u'T'} / u'_{RMS} T'_{RMS}$")
...
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'+',color='k',label=r'$G_1=\frac{1}{2}$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'+',color='r')#,label=r'$G_1=\frac{1}{2}$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'--+',color='r')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'-+',color='g')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),':+',color='b')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'x',color='k',label=r'$G_1=1$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'x',color='r')#,label=r'$G_1=1$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'--x',color='r')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'-x',color='g')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),':x',color='b')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'o',color='k',markerfacecolor='none',markeredgecolor='k',label=r'$G_1=2$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'o',color='g',markerfacecolor='none',markeredgecolor='r')#,label=r'$G_1=2$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'--',color='r',label=r'$G_2=\frac{1}{2}$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'--o',color='r',markerfacecolor='none',markeredgecolor='r')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'-',color='g',label=r'$G_2=1$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),'-o',color='g',markerfacecolor='none',markeredgecolor='g')
...
tt_cht=purge(sh3.col_values(16)[6:101])
tt_sol=purge(sh3.col_values(29)[5:135])
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),':',color='b',label=r'$G_2=2$')
plot(y_cht,ut_cht/sqrt(uu_cht*tt_cht),':o',color='b',markerfacecolor='none',markeredgecolor='b')
...
plot(y_refd,ut_refd/sqrt(uu_refd*tt_refd),'D',color='k',label=r'$isoT$',markerfacecolor='none',markeredgecolor='k')
...
savefig("all_ut_corr.png",bbox_inches='tight')
savefig("all_ut_corr.pdf",bbox_inches='tight')
