...
savefig("all_diss.png",bbox_inches='tight')
savefig("all_diss.pdf",bbox_inches='tight')

axis([-1,1,0.,0.12])
savefig("all_diss_zoom.png",bbox_inches='tight')
savefig("all_diss_zoom.pdf",bbox_inches='tight')
