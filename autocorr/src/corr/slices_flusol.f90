...
991 format('../raw/g05a2/tdyt_flu_t',I9.9,'.dat')
  write(nf,991) l
...
992 format('./g05a2_flu_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
...
993 format('./1dx_g05a2_flu_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
994 format('./1dz_g05a2_flu_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
 ...
 enddo
  ...
  io_pad=0.d0
  corr2d=0.d0
  out_data=cmplx(0.d0,0.d0)

  ! Lecture données binaires
 do l=20,20*ndt,20

996 format('../raw/g05a2/tdyt_sol_t',I9.9,'.dat')
  write(nf,996) l
...
! Write 2D FFT to file
997 format('./g05a2_sol_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
...
998 format('./1dx_g05a2_sol_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
999 format('./1dz_g05a2_sol_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
