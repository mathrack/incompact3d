...
implicit none
 ...
 integer,parameter :: nx=256,ny=8,nz=256, ndt=37500!,nt=81920!ndt=49995, nt=52488
...
991 format('./data/skew/tdyt_flu_t',I9.9,'.dat')
  write(nf,991) l
...
992 format('./skew_flu_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
...
993 format('./1dx_skew_flu_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
994 format('./1dz_skew_flu_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
