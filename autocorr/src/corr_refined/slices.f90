...
991 format('../raw/conju_ref/tdyt_sol_t',I9.9,'.dat')
  write(nf,991) l
...
992 format('./conju_sol_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
  ...
  DO k=1,nz
   DO i=1,nx
    WRITE(21,REC=COUNT) corr2d(i,jj,k)
    COUNT = COUNT + 1
   ENDDO
  ENDDO
  CLOSE(21)

993 format('./1dx_conju_sol_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
994 format('./1dz_conju_sol_jj_',I1.1,'_nx_',I3.3,'_nz_',I3.3,'_nt_',I9.9,'.dat')
