...
diric =  xlrd.open_workbook('./diric_flu_jj_1_nx_256_nz_256_nt_000075000.xls')
neuma =  xlrd.open_workbook('./neuma_flu_jj_1_nx_256_nz_256_nt_000075000.xls')
robin =  xlrd.open_workbook('./robin_flu_jj_1_nx_256_nz_256_nt_000075000.xls')
conju =  xlrd.open_workbook('./conju_flu_jj_1_nx_512_nz_512_nt_000075000.xlsx')
#
def purge(L):
...
#text(400,8,r"$isoT$",color='r')
#text(10,70,r"$isoT$",color='r')
CS = contour(X,Z,h_neum,levels = [0.1,-0.1],colors='g')
text(800,30,r"$isoQ$",color='g')
text(10,58,r"$isoQ$",color='g')
CS = contour(X,Z,h_robi,levels = [0.1,-0.1],colors='b')
text(700,11,r"$Robin$",color='b')
text(220,50,r"$Robin$",color='b')
CS = contour(XX,ZZ,h_conj,levels = [0.1,-0.1],colors='k')
text(800,41,r"$Conju.$",color='k')
text(500,80,r"$Conju.$",color='k')

savefig("autocorr_T_y0.png",bbox_inches='tight')
savefig("autocorr_T_y0.pdf",bbox_inches='tight')
