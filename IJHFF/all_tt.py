...
savefig("all_ttcht_log.png",bbox_inches='tight')
savefig("all_ttcht_log.pdf",bbox_inches='tight')

xscale('linear')
yscale('linear')
savefig("all_ttcht_lin.png",bbox_inches='tight')
savefig("all_ttcht_lin.pdf",bbox_inches='tight')

legend(bbox_to_anchor=(0.85,0.4),numpoints=1)
xscale('log')
yscale('linear')
savefig("all_ttcht_linlog.png",bbox_inches='tight')
savefig("all_ttcht_linlog.pdf",bbox_inches='tight')
