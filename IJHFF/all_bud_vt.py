...
sh2 = ref.sheet_by_name('budget_vt')
sh2n= refn.sheet_by_name('budget_vt')
sh3 = cht.sheet_by_name('budget_vt')
# y-coord
...
savefig("all_bud_vtcht.png",bbox_inches='tight')
savefig("all_bud_vtcht.pdf",bbox_inches='tight')
