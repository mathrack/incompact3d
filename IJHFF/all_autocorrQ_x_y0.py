...
y_cht=purge(sh3.col_values(0)[2:260])
# look for data
diss_bot=purge(sh1.col_values(15)[2:132])

diss_ref=purge(sh2d.col_values(15)[2:132])

diss_refn=purge(sh2n.col_values(15)[2:132])

diss_cht=purge(sh3.col_values(15)[2:260])
...
savefig("all_autocorrQ_x_y0.png",bbox_inches='tight')
savefig("all_autocorrQ_x_y0.pdf",bbox_inches='tight')
