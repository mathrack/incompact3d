...
# look for data
diss_bot=purge(sh1.col_values(13)[2:132])

diss_ref=purge(sh2d.col_values(13)[2:132])

diss_refn=purge(sh2n.col_values(13)[2:132])

diss_cht=purge(sh3.col_values(13)[2:260])
...
savefig("all_autocorr_x_y15.png",bbox_inches='tight')
savefig("all_autocorr_x_y15.pdf",bbox_inches='tight')
