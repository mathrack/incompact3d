...
# look for data
diss_bot=purge(sh1.col_values(34)[2:132])

diss_ref=purge(sh2d.col_values(34)[2:132])

diss_refn=purge(sh2n.col_values(34)[2:132])

diss_cht=purge(sh3.col_values(34)[2:260])
...
xscale('linear')
yscale('linear')
axis([-0.1,150,-0.3,1.1])
xlabel(r"$z^+$")
ylabel(r"Spanwise autocorrelation ($\partial_y T'$)")
legend(bbox_to_anchor=(1,1),numpoints=1)

savefig("all_autocorrQ_z_y0.png",bbox_inches='tight')
savefig("all_autocorrQ_z_y0.pdf",bbox_inches='tight')
