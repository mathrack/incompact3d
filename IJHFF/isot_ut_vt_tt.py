...
ut_ref=purge(sh2.col_values(2)[151:223])
vt_ref=purge(sh2.col_values(2)[226:298])
tt_ref=purge(array(sh2.col_values(2)[76:148])**2)
# plot velocity
...
xscale('log')
yscale('log')
axis([0.3,150,10**-6,6.5])
xlabel(r"$y^+$")
ylabel(r"$<u'T'>$, $<v'T'>$, $<T'^2>$")
legend(bbox_to_anchor=(0.9,0.7),numpoints=1)

savefig("isot_ut_vt_tt_log.png",bbox_inches='tight')
savefig("isot_ut_vt_tt_log.pdf",bbox_inches='tight')

xscale('linear')
yscale('linear')
savefig("isot_ut_vt_tt_lin.png",bbox_inches='tight')
savefig("isot_ut_vt_tt_lin.pdf",bbox_inches='tight')
