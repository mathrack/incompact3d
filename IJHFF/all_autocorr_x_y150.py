...
# y-coord
y_inc_bot=purge(sh1.col_values(0)[2:132])
y_ref=purge(sh2d.col_values(0)[2:132])
y_refn=purge(sh2n.col_values(0)[2:132])
y_cht=purge(sh3.col_values(0)[2:132])
# look for data
diss_bot=purge(sh1.col_values(14)[2:132])

diss_ref=purge(sh2d.col_values(14)[2:132])

diss_refn=purge(sh2n.col_values(14)[2:132])

diss_cht=purge(sh3.col_values(14)[2:132])
...
savefig("all_autocorr_x_y150.png",bbox_inches='tight')
savefig("all_autocorr_x_y150.pdf",bbox_inches='tight')
