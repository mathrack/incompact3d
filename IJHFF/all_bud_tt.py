...
cht =  xlrd.open_workbook('conju.xls')
...
somme_ref=purge(sh2d.col_values(5)[3:99])
...
plot(y_cht,somme_cht,'--',color='b',label=r'$Sum$')
...
savefig("all_bud_ttcht.png",bbox_inches='tight')
savefig("all_bud_ttcht.pdf",bbox_inches='tight')
